...
See `examples/models/prebuilt_models/prebuilt_models_README.md` for all available templates.
...
**Documentation:**
- `docs/model_building.md` - Model construction
...
**Advanced:**
- `examples/models/custom/` - Custom model construction
